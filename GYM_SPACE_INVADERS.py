...
# Directories
SAVE_DIR = 'models/GymSpaceInvaders/ExpectedSarsa'
ROOT_TF_LOG = 'tf_logs'
...
def generate_gif(frames, pathName, game_count, game_reward):
    ...
    imageio.mimsave(f'{SAVE_DIR}{"/GymSpaceInvaders-{}-{}-{}.gif".format(pathName, game_count, game_reward)}', frames, duration=1/30)
